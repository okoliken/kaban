...
export const ThemeToggle = () => {
  ...
  return (
    <div className="w-[15.688rem] h-12 bg-light-gray dark:bg-[#20212C] rounded-[0.375rem] mb-[0.5rem] flex items-center justify-center gap-x-[1.479rem]">
      <SunIcon />
      <Switch
...
export const BoardList = () => {
  return (
    <ul className="pt-[1.188rem] pr-6">
      <li>
        <button className="w-full bg-primary-1 hover:bg-primary-1/10 dark:hover:bg-white group pl-[2rem] h-12 pr-[2rem] rounded-tr-[6.25rem] rounded-br-[6.25rem] flex items-center gap-x-4">
          <BoardIcon />
      ...
      <div className="w-full cursor-pointer pl-[2rem] hover:opacity-70 transition-opacity duration-75 ease-in-out h-12 pr-[2rem] rounded-tr-[6.25rem] rounded-br-[6.25rem] flex items-center gap-x-4">
      <svg
            aria-hidden="true"
...
export const Sidebar = () => {
  ...
  return (
    <aside className="bg-white dark:bg-[#2B2C37] w-full max-w-[18.75rem] border-r border-soft-gray dark:border-[#3E3F4E] pt-[2.049rem] flex flex-col justify-between">
      <div>
