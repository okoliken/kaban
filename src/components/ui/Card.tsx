...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[0.5rem] bg-white text-neutral-950 shadow-ll dark:border-neutral-800 dark:bg-[#2B2C37] dark:text-neutral-50 px-4 py-[1.438rem] leading-[1.181rem] hover:text-primary-1",
